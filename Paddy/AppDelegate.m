...
//    [[UITextView appearance] setKeyboardAppearance:UIKeyboardAppearanceDark];
    ...
    [[UINavigationBar appearance] setBarTintColor:[UIColor colorWithHexNum:0xFBFBFB alpha:1.0]];
    [[UINavigationBar appearance] setTintColor:[UIColor colorWithHexNum:0x037AFF alpha:1.0]];
    [[UINavigationBar appearance] setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithHexNum:0xFBFBFB alpha:0.04]] forBarMetrics:UIBarMetricsDefault];
...
- (void)applicationWillTerminate:(UIApplication *)application {
    ...
    [[NotesManager sharedNotesManager] exit];
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.liau-jian-jie.Paddy2" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Paddy" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Paddy.sqlite"];
    NSError *error = nil;
